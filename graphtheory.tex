...
\input{sec:graphs-intro.tex}

\input{sec:real-world-intro.tex}

\input{sec:language-rationale.tex}

\input{sec:other-basic-notions.tex}
...
A particularly important case of this is when $S' = \overline S$, the
